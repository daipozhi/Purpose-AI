...
int main(void)
{
	MessageBox(0,"load words04.txt  grammar-cw03.sort.txt  words-cw02.sort.txt  , write to words04a.txt ","message",MB_OK);
...
*/
	...
	printf("words04.txt ok,read=%d,insert=%d,t1_buff_ptr=%d,\n",rd,ins,t1_buff_ptr);
