...
#define BTREE8_SIZE   5000
#define BTREE8_LSIZE  5000

    char  t8_node_mark[BTREE8_SIZE];

    long long int   t8_node_val[BTREE8_SIZE][4];
    long long int   t8_node_va2[BTREE8_SIZE];

	  int  t8_node_v_sid[BTREE8_SIZE][150];
...
long long int  t8_node_v_val1[BTREE8_SIZE];
long long int  t8_node_v_val2[BTREE8_SIZE];
long long int  t8_node_v_val3[BTREE8_SIZE];
long long int  t8_node_v_val4[BTREE8_SIZE];

long long int  t8_node_v_sval[BTREE8_SIZE][150][4];

	  char t8_node_v_pat[BTREE8_SIZE][150][10][2];
	  char t8_node_v_pat_ptr[BTREE8_SIZE][150];
    ...
    int   t8_search_node(long long int pn1,long long int pn2,long long int pn3,long long int pn4,long long int pn5);
    int   t8_insert_node(long long int pn1,long long int pn2,long long int pn3,long long int pn4,long long int pn5);
    int   t8_delete_node(long long int pn1,long long int pn2,long long int pn3,long long int pn4,long long int pn5);
    int   t8_smallest(void);
    int   t8_istrcmp(int i,long long int pn1,long long int pn2,long long int pn3,long long int pn4,long long int pn5);
