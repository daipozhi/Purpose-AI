...
#define BTREE7_LSIZE  1500
    ...
    long long int   t7_node_va2[BTREE7_SIZE];
    	      int   t7_node_va3[BTREE7_SIZE];
    ...
    char  t7_out_mark[BTREE7_SIZE];

    long long int   t7_out_val[BTREE7_SIZE][4];
    long long int   t7_out_va2[BTREE7_SIZE];
    int		    t7_out_va3[BTREE7_SIZE];
    ...
    int   t7_search_node(long long int pn1,long long int pn2,long long int pn3,long long int pn4,long long int pn5);
    int   t7_insert_node(long long int pn1,long long int pn2,long long int pn3,long long int pn4,long long int pn5);
    int   t7_delete_node(long long int pn1,long long int pn2,long long int pn3,long long int pn4,long long int pn5);
    int   t7_smallest(void);
    int   t7_istrcmp(int i,long long int pn1,long long int pn2,long long int pn3,long long int pn4,long long int pn5);
...
int t7_search_node(long long int pn1,long long int pn2,long long int pn3,long long int pn4,long long int pn5)
{
  ...
  while (1)
  {
    res=t7_istrcmp(i,pn1,pn2,pn3,pn4,pn5);
...
int t7_insert_node(long long int pn1,long long int pn2,long long int pn3,long long int pn4,long long int pn5)
{
  ...
  i=t7_search_node(pn1,pn2,pn3,pn4,pn5);
  ...
  while (t7_list_ptr>0)
  {
    ...
    if (t7_list_stack_type[j]==1)
    {
      ...
      if (t7_node_ptr[k][1]>=0)
      {
        ...
        {
          MessageBoxNow(0,"In btree10,error in after_list(),BTREE7_LSIZE too small.","message",MB_OK);
          continue;
        }
...
int t7_out_list(int ptr)
{
  ...
  t7_out_val[t7_out_ptr][0]=t7_node_val[ptr][0];
  t7_out_val[t7_out_ptr][1]=t7_node_val[ptr][1];
  t7_out_val[t7_out_ptr][2]=t7_node_val[ptr][2];
  t7_out_val[t7_out_ptr][3]=t7_node_val[ptr][3];
  
  t7_out_va2[t7_out_ptr]=t7_node_va2[ptr];
  t7_out_va3[t7_out_ptr]=t7_node_va3[ptr];
