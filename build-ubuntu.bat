...
cd ../webfind53
gcc -o a-step90.exe webfind53.c tree2.c tree2b.c
cp a-step90.exe ../work_dir
cd ../webfind54
gcc -o a-step100.exe webfind54.c tree2.c tree2c.c
cp a-step100.exe ../work_dir
cd ../webfind61
gcc -o a-step210.exe webfind61.c load12.c spl1.c spl2.c tree2.c tree2b.c tree2c.c tree2d.c tree2e.c tree2f.c
