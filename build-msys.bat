...
cd ../webfind29f
rm a-step50.exe
gcc -o a-step50.exe webfind29-m.c spl1.c tree2.c tree2b.c btree4.c -liconv
...
cd ../webfind53e
rm a-step90.exe
gcc -o a-step90.exe webfind53-m.c spl1.c tree2.c tree2b.c btree4.c -liconv
...
cd ../webfind61f
rm a-step210.exe
gcc -o a-step210.exe webfind61-m.c wd56.c grm1516.c spl1.c spl2.c tree2b.c tree2d.c btree6.c btree8.c btree10.c -liconv
...
gcc -o app_separ.exe webfind65.c my_wd56.c my_grm1516.c my_spl1.c my_spl2.c my_tree2b.c my_tree2d.c my_btree6.c my_btree8.c my_btree10.c -liconv
