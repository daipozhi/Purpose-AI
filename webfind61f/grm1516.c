...
/*
#define TREE_SIZE_C 20000000   // grammar db
#define LIST_SIZE_C  2000000

int t3_search_node(int pn1,int pn2,int pn3,int pn4);
int t3_insert_node(int pn1,int pn2,int pn3,int pn4);
int t3_init_tree2(void);

//int t3_node_val[TREE_SIZE_C][4];
